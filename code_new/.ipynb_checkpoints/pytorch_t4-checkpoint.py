...
print(len(tokenized_train_captions1))
...
print(len(tokenized_val_captions1))
...
print(len(tokenized_test_captions1))
...
model.load_state_dict(torch.load(f'/data/admitosstorage/Phase_2/trained_models/united_model_pytorch_mlm_sp_e10.pt', map_location=device))
