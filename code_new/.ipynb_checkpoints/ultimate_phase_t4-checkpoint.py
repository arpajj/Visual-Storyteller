...
with open(mathcing_path_test, 'r', encoding='utf-8') as f:
...
predictor = Predictor()
my_clipcap_model = predictor.setup(WEIGHTS_PATH1)
...
model.load_state_dict(torch.load(f'/data/admitosstorage/Phase_2/trained_models/united_model_pytorch_e25_v1.pt', map_location=D))
